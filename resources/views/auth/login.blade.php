    <div class="min-h-screen flex items-center justify-center bg-[#111344] p-4">
        <div class="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 bg-[#1E293B] p-12 text-white flex flex-col justify-center relative overflow-hidden">
                ...
                <div class="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#111344] to-transparent opacity-80"></div>
            ...
            <div class="md:w-1/2 bg-[#E2E8F0] p-12 flex flex-col justify-center">
                <div class="max-w-md mx-auto w-full">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <!-- Email Address -->
                        <div>
                            <label for="email" class="block text-sm font-semibold text-[#111344] mb-1">Correo electrónico</label>
                            <div class="relative">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-sm font-semibold text-[#111344] mb-1">Contraseña</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    <svg class="h-5 w-5 text-gray-400 cursor-pointer hover:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- Include Remember Me & Forgot Password logic here or keep it minimum as in prototype -->
                         <div class="flex items-center justify-between">
                            <label for="remember_me" class="inline-flex items-center">
                                <input id="remember_me" type="checkbox" class="h-4 w-4 bg-gray-500 border-gray-300 rounded focus:ring-blue-500 text-[#1E293B]" name="remember">
                        ...
                        <div class="text-center mt-4">
                            @if (Route::has('password.request'))
                                <a class="text-sm font-medium text-gray-500 hover:text-blue-700" href="{{ route('password.request') }}">
