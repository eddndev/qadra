                    ...
                    <form method="POST" action="{{ route('register.invited.store') }}" class="space-y-5">
                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="password" x-bind:type="show ? 'text' : 'password'" name="password"
                                    required autocomplete="new-password" class="pl-10 pr-10 placeholder-gray-400"
                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="password_confirmation" x-bind:type="show ? 'text' : 'password'"
                                    name="password_confirmation" required autocomplete="new-password"
                                    class="pl-10 pr-10 placeholder-gray-400" placeholder="Repite la contraseña" />
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    <button type="button" @click="show = !show"
                                        class="focus:outline-none text-gray-400 hover:text-gray-600 transition-colors">
                                        <svg x-show="!show" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
