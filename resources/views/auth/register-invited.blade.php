<x-guest-layout>
    <form method="POST" action="{{ route('register.invited.store') }}">
        ...
        <div class="mb-4 text-sm text-gray-600">
            Estás aceptando la invitación para unirte al despacho <strong>{{ $invitation->tenant->name }}</strong> como
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full bg-gray-100 cursor-not-allowed" type="email" name="email"
