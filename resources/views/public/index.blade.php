...
@section('content')
            ...
            <div class="mx-auto max-w-2xl text-center">
                <div class="mb-8 flex justify-center">
                    <div
                        ...
                        Novedades: Versión Estable Disponible. <a href="#" class="font-semibold text-white"><span
    ...
    <div class="relative bg-slate-50 overflow-hidden" id="features">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <div
                class="absolute inset-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-40">
            </div>
        ...
        <section class="relative z-10 py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div
                class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 border border-brand-100 text-brand-600 text-sm font-medium mb-6">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-brand-900 tracking-tight mb-6 font-sans">
                Control total y <span
                    class="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-brand-400">confidencialidad</span>
        ...
        <section class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div
                    class="group relative bg-white rounded-2xl p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                    <div
                        class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-brand-500 to-brand-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    </div>
                    <div class="flex flex-col sm:flex-row items-start gap-6">
                        <div class="flex-shrink-0">
                            {{-- Icon Container: Circular (rounded-full) with brand-50 bg --}}
                            <div
                                class="w-16 h-16 rounded-full bg-brand-50 flex items-center justify-center text-brand-600 group-hover:bg-brand-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                        ...
                        <div>
                            <h3
                                class="text-2xl font-bold text-brand-900 mb-3 font-sans group-hover:text-brand-600 transition-colors">
                                Expedientes Digitales</h3>
                            <p class="text-slate-600 leading-relaxed text-base">
                                Organiza expedientes, documentos y notas en un solo lugar seguro. Accede a la información
                                crítica al instante.
                            </p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row items-start gap-6">
                        ...
                        <div>
                            <h3
                                class="text-2xl font-bold text-brand-900 mb-3 font-sans group-hover:text-brand-600 transition-colors">
                                Calendario y Notificaciones</h3>
                            <p class="text-slate-600 leading-relaxed text-base">
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row items-start gap-6">
                        ...
                        <div>
                            <h3
                                class="text-2xl font-bold text-brand-900 mb-3 font-sans group-hover:text-brand-600 transition-colors">
                                Gestión Reservada de Datos</h3>
                            <p class="text-slate-600 leading-relaxed text-base">
                                Entornos de trabajo exclusivos para cada despacho, respetando la confidencialidad de su
                                práctica legal.
                            </p>
                        </div>
                    </div>
    ...
    <section id="pricing" class="bg-neutral-50 py-16 sm:pt-[20px] sm:pb-24 scroll-mt-24">
        <div class="container-app relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-start">
                ...
                <!-- Starter Plan -->
                <div
                    class="bg-white rounded-2xl border border-slate-100 p-6 shadow-md hover:shadow-lg transition-all duration-300 relative z-0">
                    ...
                    <a href="{{ route('register') }}"
                        class="mt-6 block w-full py-3 rounded-xl bg-[#1E40AF] text-center text-sm font-bold text-white shadow-sm hover:bg-brand-900 transition-all duration-300">
                        Comenzar
                    </a>
                </div>
                ...
                <div
                    class="relative bg-white rounded-2xl border border-brand-500 shadow-2xl z-10 transform md:-translate-y-4 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('register') }}"
                            class="mt-8 block w-full py-4 rounded-xl bg-[#1E40AF] text-center text-sm font-bold text-white shadow-lg hover:bg-brand-900 hover:scale-105 transition-all duration-300">
                            Obtener Acceso
                        </a>
                    </div>
                </div>
