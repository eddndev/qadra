    ...
    <section class="relative bg-brand-900 overflow-hidden isolate">
        ...
        <div class="container-app py-24 sm:py-32 lg:pb-40">
            ...
            <div class="mt-10 flow-root sm:mt-24">
                <div
                    class="-mx-6 md:mx-0 md:-m-2 md:rounded-xl md:bg-white/5 md:p-2 md:ring-1 md:ring-inset md:ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                    <!-- This would be a screenshot of the dashboard -->
                    <div
                        class="aspect-[16/9] w-full bg-neutral-800 shadow-2xl ring-1 ring-neutral-900/10 overflow-hidden md:rounded-md">
                        <x-landing-image key="dashboard_preview" class="w-full h-full object-cover"
