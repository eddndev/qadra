<section>
    ...
    <div class="flex items-start gap-6 mb-8 pb-8 border-b border-gray-100">
        <div class="relative">
            <div
                class="h-24 w-24 rounded-full bg-gray-200 flex items-center justify-center text-3xl font-bold text-gray-500">
                {{ substr($user->name, 0, 2) }}
            </div>
            <button
                class="absolute bottom-0 right-0 bg-[#1E293B] text-white p-2 rounded-full hover:bg-gray-700 transition-colors">
