<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <h1 class="text-3xl font-bold text-[#111344] mb-6">Configuración</h1> <!-- Header matches prototype text even if contextually 'Create Case' -->
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <!-- Datos Generales -->
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <x-text-input wire:model="internal_folio" id="internal_folio" class="block mt-1 w-full bg-gray-50" type="text" placeholder="Ej: CG-2024-002567" required />
                                <x-input-error :messages="$errors->get('internal_folio')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="crime_type" :value="__('Delito principal *')" />
                                <select wire:model="crime_type" id="crime_type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            ...
                            <!-- Mock fields for Courts/Prosecutor to match prototype visualization -->
                             <div>
                                ...
                                <select wire:model="court_name" id="court_name" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                             ...
                             <div>
                                ...
                                <select wire:model="prosecutor_name" id="prosecutor_name" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                             ...
                             <div>
                                ...
                                <x-text-input wire:model="start_date" id="start_date" class="block mt-1 w-full" type="text" placeholder="dd/mm/aaaa" onfocus="(this.type='date')" onblur="(this.type='text')" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 p-6">
                         <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-2 text-[#111344]">
                             ...
                             <button type="button" class="text-xs bg-[#111344] text-white px-3 py-1.5 rounded hover:bg-blue-900 flex items-center gap-1">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Other Roles -->
                            <div>
                                <x-input-label :value="__('Fiscal a cargo')" class="text-xs text-gray-500 uppercase font-bold" />
                            ...
                            <div>
                                ...
                                <x-text-input class="block mt-1 w-full text-sm" placeholder="Nombre del juez (opcional)" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center gap-2 mb-4 text-[#111344]">
                         ...
                         <div class="space-y-4">
                           <div>
                                ...
                                <select wire:model="stage" id="stage" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Plazos Iniciales -->
                    <div class="bg-blue-50 dark:bg-gray-800 shadow-sm rounded-lg border border-blue-100 p-6">
                        <div class="flex items-center justify-between mb-4 text-[#111344]">
                            ...
                            <button type="button" class="text-xs bg-blue-600 text-white px-2 py-1 rounded hover:bg-blue-700 flex items-center gap-1">
                                + Agregar plazo
                            </button>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-white p-3 rounded border border-blue-200">
                                <div class="flex items-center gap-2 mb-2">
                                    <span class="bg-[#111344] text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full">1</span>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                         ...
                                         <input type="text" placeholder="dd/mm/aaaa" class="block w-full text-sm border-gray-300 rounded shadow-sm py-1" onfocus="(this.type='date')" onblur="(this.type='text')" />
                                    </div>
                                    <div>
                                         <x-input-label :value="__('Observaciones')" class="text-xs" />
                                         <input type="text" placeholder="Notas sobre este plazo (opcional)" class="block w-full text-sm border-gray-300 rounded shadow-sm py-1" />
                                    </div>
                                </div>
                            </div>
                            
                            <div class="flex items-start gap-2 text-xs text-gray-500">
                                <svg class="w-4 h-4 mt-0.5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        <div>
                             ...
                             <textarea wire:model="notes" id="notes" rows="4" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm resize-none" placeholder="Añade observaciones, notas importantes o contexto del caso que puedan ser útiles para el equipo..."></textarea>
                        </div>
                         
                         <div class="mt-4 flex items-start gap-2 text-xs text-gray-500">
                             <input type="checkbox" class="mt-0.5" />
                             <p>Estas notas solo serán visibles para miembros autorizados del equipo. No se incluyen en documentos oficiales.</p>
                         </div>
                    </div>

                    <!-- Actions -->
                    <div class="pt-4 space-y-3">
                        <button type="submit" class="w-full justify-center inline-flex items-center px-4 py-2 bg-[#334D6E] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#243b55] focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            Guardar y abrir expediente
                        </button>
                        <button type="button" class="w-full justify-center inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
