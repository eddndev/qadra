    ...
    <x-modal name="change-stage-modal" focusable>
        <div class="p-6">
            ...
            <p class="text-sm text-gray-500 mb-6">
                Registra el avance procesal del caso. Esta acción quedará guardada en el historial inmutable del
                expediente.
            </p>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select wire:model="new_stage" id="new_stage"
                ...
                <div>
                    ...
                    <select wire:model="new_status" id="new_status"
                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <textarea wire:model="reason" id="reason" rows="3"
                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                        placeholder="Ej. Se dictó auto de vinculación a proceso en la audiencia inicial..."></textarea>
