    ...
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">Fecha y Hora del Movimiento *</label>
                <input type="datetime-local" wire:model="movement_at"
            ...
            <div class="bg-gray-50 p-4 rounded border border-gray-200">
                <h4 class="font-medium text-gray-700 mb-3 border-b pb-2">Entrega (Origen)</h4>

                <label class="block text-sm font-medium text-gray-700 mb-1">Nombre Completo *</label>
                <input type="text" wire:model="given_by"
                    class="w-full mb-3 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                @error('given_by') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror

                <label class="block text-sm font-medium text-gray-700 mb-1">Placa / Cargo / ID</label>
                <input type="text" wire:model="given_by_badge"
                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <!-- Quien Recibe -->
            <div class="bg-gray-50 p-4 rounded border border-gray-200">
                <h4 class="font-medium text-gray-700 mb-3 border-b pb-2">Recibe (Destino)</h4>
                ...
                <label class="block text-sm font-medium text-gray-700 mb-1">Placa / Cargo / ID</label>
                <input type="text" wire:model="received_by_badge"
                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div class="col-span-1 md:col-span-2 border-t pt-4 mt-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Motivo del Movimiento *</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Nueva Ubicación Física *</label>
                        <input type="text" wire:model="location" placeholder="Ej: Bodega Fiscalía Zona 1"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <!-- Condición -->
            <div class="col-span-1 md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">Condición de la Evidencia / Embalaje
                    *</label>
                <textarea wire:model="condition" rows="2"
