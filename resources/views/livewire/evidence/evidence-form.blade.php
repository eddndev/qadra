    ...
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                <label for="case_id" class="block text-sm font-medium text-gray-700 mb-1">Caso Vinculado *</label>
            ...
            <!-- Tipo de Evidencia -->
            <div>
                <label for="type" class="block text-sm font-medium text-gray-700 mb-1">Tipo de Evidencia *</label>
            ...
            <!-- Ubicación Inicial -->
            <div>
                <label for="current_location" class="block text-sm font-medium text-gray-700 mb-1">Ubicación Física
                    Inicial *</label>
                <input type="text" wire:model="current_location" id="current_location"
                    placeholder="Ej: Bodega de Evidencias, Caja Fuerte"
                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <!-- Descripción -->
            <div class="col-span-1 md:col-span-2">
                <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Descripción Detallada del
                    Objeto *</label>
            ...
            <div>
                <label for="collected_at" class="block text-sm font-medium text-gray-700 mb-1">Fecha y Hora de
                    Recolección *</label>
            ...
            <!-- Recolectado Por -->
            <div>
                <label for="collected_by" class="block text-sm font-medium text-gray-700 mb-1">Recolectado Por
                    (Autoridad)</label>
                <input type="text" wire:model="collected_by" id="collected_by" placeholder="Nombre del oficial o perito"
                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
